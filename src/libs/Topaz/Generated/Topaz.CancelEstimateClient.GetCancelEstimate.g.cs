...
namespace Topaz
{
    public partial class CancelEstimateClient
    {


        private static readonly global::Topaz.EndPointSecurityRequirement s_GetCancelEstimateSecurityRequirement0 =
        ...
        private static readonly global::Topaz.EndPointSecurityRequirement[] s_GetCancelEstimateSecurityRequirements =
            new global::Topaz.EndPointSecurityRequirement[]
            {                s_GetCancelEstimateSecurityRequirement0,
            };
        partial void PrepareGetCancelEstimateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid requestId);
        partial void PrepareGetCancelEstimateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid requestId);
        partial void ProcessGetCancelEstimateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCancelEstimateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Topaz.CancelEstimateResponse> GetCancelEstimateAsync(
            global::System.Guid requestId,
            global::Topaz.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetCancelEstimateAsResponseAsync(
                requestId: requestId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Topaz.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Topaz.AutoSDKHttpResponse<global::Topaz.CancelEstimateResponse>> GetCancelEstimateAsResponseAsync(
            global::System.Guid requestId,
            global::Topaz.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetCancelEstimateArguments(
            ...
            var __authorizations = global::Topaz.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetCancelEstimateSecurityRequirements,
                operationName: "GetCancelEstimateAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Topaz.PathBuilder(
                                path: $"/video/{requestId}/cancel-estimate",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetCancelEstimateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Topaz.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Topaz.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetCancelEstimateAsync",
                                pathTemplate: "$\"/video/{requestId}/cancel-estimate\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetCancelEstimateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Topaz.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Topaz.GetCancelEstimateResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Topaz.GetCancelEstimateResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Topaz.ApiException<global::Topaz.GetCancelEstimateResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Topaz.GetCancelEstimateResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Topaz.GetCancelEstimateResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Topaz.ApiException<global::Topaz.GetCancelEstimateResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Topaz.GetCancelEstimateResponse3? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Topaz.GetCancelEstimateResponse3.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Topaz.ApiException<global::Topaz.GetCancelEstimateResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Topaz.GetCancelEstimateResponse4? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Topaz.GetCancelEstimateResponse4.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Topaz.ApiException<global::Topaz.GetCancelEstimateResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::Topaz.GetCancelEstimateResponse5? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::Topaz.GetCancelEstimateResponse5.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Topaz.ApiException<global::Topaz.GetCancelEstimateResponse5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetCancelEstimateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Topaz.CancelEstimateResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Topaz.AutoSDKHttpResponse<global::Topaz.CancelEstimateResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Topaz.CancelEstimateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
