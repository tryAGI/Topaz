...
namespace Topaz
{
    public partial class VideoStatusClient
    {


        private static readonly global::Topaz.EndPointSecurityRequirement s_GetSystemStatusSecurityRequirement0 =
        ...
        private static readonly global::Topaz.EndPointSecurityRequirement[] s_GetSystemStatusSecurityRequirements =
            new global::Topaz.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Topaz.SystemStatusResponse> GetSystemStatusAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Topaz.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Topaz.AutoSDKHttpResponse<global::Topaz.SystemStatusResponse>> GetSystemStatusAsResponseAsync(
            global::Topaz.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Topaz.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Topaz.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetSystemStatusAsync",
                                pathTemplate: "\"/video/status\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Topaz.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::Topaz.GetSystemStatusResponse? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::Topaz.GetSystemStatusResponse.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Topaz.ApiException<global::Topaz.GetSystemStatusResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Topaz.AutoSDKHttpResponse<global::Topaz.SystemStatusResponse>(
                                        statusCode: __response.StatusCode,
