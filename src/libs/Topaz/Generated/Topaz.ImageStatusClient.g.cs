...
namespace Topaz
{
    ...
    /// This is particularly useful for long-running jobs, where you can track progress and retrieve details such as percentage completion, estimated finish time, and current state (e.g., pending, processing, completed).<br/>
    /// If no httpClient is provided, a new one will be created.<br/>
    /// If no baseUri is provided, the default baseUri from OpenAPI spec will be used.
    /// </summary>
    public sealed partial class ImageStatusClient : global::Topaz.IImageStatusClient, global::System.IDisposable
    {
        /// <summary>
        /// Production
        /// </summary>
        ...
        internal global::System.Lazy<global::System.Text.Json.Serialization.JsonSerializerContext> JsonSerializerContextProvider { get; set; } = new(() => global::Topaz.ImageStatusSourceGenerationContext.Default);
        ...
        /// <summary>
        /// Creates a new instance of the ImageStatusClient with explicit options but no base URL override.
