...
namespace Topaz
{
    public partial class ImageStatusClient
    {
        ...
        private static readonly global::Topaz.EndPointSecurityRequirement s_GetAllStatusesSecurityRequirement0 =
        ...
        private static readonly global::Topaz.EndPointSecurityRequirement[] s_GetAllStatusesSecurityRequirements =
            new global::Topaz.EndPointSecurityRequirement[]
            {                s_GetAllStatusesSecurityRequirement0,
            };
        partial void PrepareGetAllStatusesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? paginated,
            ref int? limit,
            ref string? cursor);
        partial void PrepareGetAllStatusesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? paginated,
            int? limit,
            string? cursor);
        partial void ProcessGetAllStatusesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAllStatusesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Topaz.OneOf<global::System.Collections.Generic.IList<global::Topaz.StatusResponse>, global::Topaz.PaginatedStatusesResponse>> GetAllStatusesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Topaz.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAllStatusesSecurityRequirements,
                operationName: "GetAllStatusesAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Topaz.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Topaz.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetAllStatusesAsync",
                ...
                else
                {
                    await global::Topaz.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Topaz.GetAllStatusesResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Topaz.GetAllStatusesResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Topaz.ApiException<global::Topaz.GetAllStatusesResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Topaz.GetAllStatusesResponse3? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Topaz.GetAllStatusesResponse3.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Topaz.ApiException<global::Topaz.GetAllStatusesResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Topaz.GetAllStatusesResponse4? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Topaz.GetAllStatusesResponse4.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Topaz.ApiException<global::Topaz.GetAllStatusesResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Topaz.GetAllStatusesResponse5? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Topaz.GetAllStatusesResponse5.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Topaz.ApiException<global::Topaz.GetAllStatusesResponse5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::Topaz.GetAllStatusesResponse6? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::Topaz.GetAllStatusesResponse6.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Topaz.ApiException<global::Topaz.GetAllStatusesResponse6>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAllStatusesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
